        ...
        <div class="col-12 mt-4">
          <div class="card">
            <div class="card-header pb-0 px-3">
              <h6 class="mb-0">News Management</h6>
            </div>
                ...
                <?php foreach ($news as $item): ?>
                  <li class="list-group-item border-0 d-flex justify-content-between align-items-center p-4 mb-2 bg-gray-100 border-radius-lg">
                    <div class="d-flex flex-column  " style="width: 40%">
                      ...
                      <span class="mb-2 text-xs">Category: <span class="text-dark font-weight-bold ms-sm-2"><?= htmlspecialchars($item['category']) ?></span></span>
                      <span class="mb-2 text-xs">Author: <span class="text-dark font-weight-bold ms-sm-2"><?= htmlspecialchars($item['author']) ?></span></span>
                      <span class="text-xs">Created at: <span class="text-dark font-weight-bold ms-sm-2"><?= $item['created_at'] ?></span></span>
                    </div>
