...
<head>
	...
	<!--===============================================================================================-->
	<link rel="icon" type="image/png" href="pages/uploads/icons/favicon.png" />
	<!--===============================================================================================-->
            ...
            <ul class="p-t-35">
                ...
                ?>
                    <li class="how-bor3 p-rl-4">
                        <a href="category.php?id=<?= $category['id'] ?>" class="dis-block f1-s-10 text-uppercase cl2 hov-cl10 trans-03 p-tb-13">
            ...
            <ul class="p-t-35">
                ...
                ?>
                    <li class="flex-wr-sb-s p-b-30">
                        ...
                        <div class="size-w-11">
                            <h6 class="p-b-4">
                                <a href="news_detail.php?id=<?= $latest['id'] ?>" class="f1-s-5 cl3 hov-cl10 trans-03">
