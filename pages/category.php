    ...
    <div class="container">
        <div class="bg0 flex-wr-sb-c p-rl-20 p-tb-8">
            <div class="f2-s-1 p-r-30 m-tb-6">
                <a href="<?php echo SITE_URL; ?>index.php" class="breadcrumb-item f1-s-3 cl9">
                    Home
                </a>
                                    ...
                                    <div class="p-b-53">
                                        ...
                                        <div class="flex-col-s-c p-t-16">
                                            <h5 class="p-b-5 txt-center">
                                                <a href="<?php echo SITE_URL; ?>pages/news_detail.php?id=<?php echo $post['id']; ?>" class="f1-m-3 cl2 hov-cl10 trans-03">
                                            ...
                                            <a href="<?php echo SITE_URL; ?>pages/news_detail.php?id=<?php echo $post['id']; ?>" class="f1-s-1 cl9 hov-cl10 trans-03">
                                                Read More
