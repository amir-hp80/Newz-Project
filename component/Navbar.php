    ...
    <div class="container-menu-desktop">
        ...
        <div class="menu-mobile">
            <ul class="main-menu-m">
                ...
                <li><a href="<?php echo SITE_URL; ?>/pages/login.php">SignIn / SignUp</a></li>
            </ul>
        </div>
                ...
                <nav class="menu-desktop">
                    ...
                    <ul class="main-menu">
                            ...
                            <div class="sub-mega-menu">
                                <div class="nav flex-column nav-pills" role="tablist">
                                    <a class="nav-link <?= ($current_page == 'category.php' && !isset($_GET['id'])) ? 'active' : '' ?>"
                                        href="<?php echo SITE_URL; ?>pages/category.php">All</a>
                        ...
                        <li class="login-btn <?= ($current_page == 'login.php') ? 'main-menu-active' : '' ?>">
                            <a href="<?php echo SITE_URL; ?>pages/sign-in.php">SignIn / SignUp</a>
                        </li>
                    </ul>
